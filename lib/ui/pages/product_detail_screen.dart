...
class ProductDetailScreen extends StatelessWidget {
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Padding(
                            ...
                            child: Obx(
                              () {
                                var currentMemberPrice;
                                if (productController
                                    .varient.value.msdApplicableProduct!) {
                                  currentMemberPrice = Helper.getMsdAmount(
                                      price: productController
                                          .varient.value.price!,
                                      userType: stateController.userType.value);
                                }
                                var minOrder = (productController
                                                .varient.value.constraint !=
                                            null &&
                                        ...
                                        productController.varient.value
                                            ...
                                            0)
                                    ? productController
                                        .varient.value.constraint!.minimumOrder
                                    : 1;
                                    ...
                                    Card(
                                      child: Padding(
                                        padding: const EdgeInsets.fromLTRB(
                                            8.0, 4, 8, 4),
                                        child: Text(
                                          "${productController.varient.value.msdApplicableProduct! ? currentMemberPrice.toString() : productController.varient.value.price!.offerPrice!.toString()}${CodeHelp.euro}",
                                          style: TextStyles.headingFont,
                                        ),
                                      ),
                                    ),
                                    checkProductAvailability(productController)
                                        ? Row(
                                            mainAxisAlignment:
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (stateController
                                                    ...
                                                    if (productController
                                                        .varient
                                                        .value
                                                        .msdApplicableProduct!) {
                                                      await cartController
                                                          .addToCartMSD(
                                                              '$refId@${productController.varient.value.varientCode}',
                                                              addedFrom!,
                                                              -minOrder!,
                                                              productController
                                                                  .varient
  ...
  checkProductAvailability(productController) {
    if (productController.varient.value.msdApplicableProduct!) {
